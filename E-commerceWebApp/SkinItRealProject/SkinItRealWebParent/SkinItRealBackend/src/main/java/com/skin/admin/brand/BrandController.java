...
public class BrandController {
	...
	public String saveBrand(Brand brand,@RequestParam("fileImage")MultipartFile multipartFile,
		...
		if (!multipartFile.isEmpty()) {
			...
			String uploadDir = "SkinItRealWebParent/SkinItRealBackend/src/main/resources/static/images/brand-logos/" + savedBrand.getId();
	...
	public String deleteBrand(@PathVariable(name="id")Integer id,Model model,RedirectAttributes ra) {
		try {
			...
			ra.addFlashAttribute("mesage", ex.getMessage());
