...
public class CategoryController {
	...
	public String saveCategory(Category category,
		...
		String uploadDir="SkinItRealWebParent/SkinItRealBackend/src/main/resources/static/images/category-images/"+savedCategory.getId();
		String uploadDir2 = "SkinItRealWebParent/SkinItRealFrontend/src/main/resources/static/images/category-images/" + savedCategory.getId();
	...
	public String deleteCategory(@PathVariable(name="id")Integer id,Model model,RedirectAttributes redirectAttributes) {
		try {
			service.delete(id);
			String categoryDir="../catehory-images/"+id;
